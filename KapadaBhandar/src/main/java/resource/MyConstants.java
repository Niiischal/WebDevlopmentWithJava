...
public class MyConstants {
	...
	public static final String REGISTERUSER = "INSERT INTO registration (firstName,lastName,address,email,username,password,image) VALUES (?,?,?,?,?,?,?)";
	...
	public static final String UPDATEUSER = "UPDATE registration SET firstName=?, lastName=?, address=? , email=?, username=?, password=?, image=? WHERE userID = ?";
