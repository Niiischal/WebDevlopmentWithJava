...
<body>
	...
	<div class="nav">
		...
		<div class="nav-links">
			<a href="../index.jsp" target="_blank">Home</a> <a href="search.jsp">Search</a>
			<%
			if (mySession.checkUser(user)) {
			%>
			<a href="cart.jsp">View Cart</a> <a href="user.jsp" target="_blank">Profile</a>
			<%
			}
			%>
			<form
	...
	<div class="container">
		<div class="options">
			<form class="searchfield" action="search.jsp">
				<input type="text" name="productName"
					placeholder="Enter the product name" /> <input type="submit"
					value="Search">
			</form>
		...
		<div class="box-container">
			...
			<sql:query var="products" dataSource="${dbconnection}">
				SELECT  * from product WHERE productCategory="Women";
			</sql:query>
				...
				<div class="box">
					...
					<form action="<%=request.getContextPath()%>/AddToCart"
						...
						<input type="submit" value="Add to Cart" class="btn"> <input
							type="hidden" name="productID" value="${user}"> <input
